...
public class SettingBuilderTest {
	...
	public void testLoadFromFileMinProp() throws IOException, CertificateException, URISyntaxException, SettingsException, Error {
		...
		assertEquals("http://localhost:5050/java-saml-jspsample/metadata.jsp", setting.getSpEntityId());
		assertEquals("http://localhost:5050/java-saml-jspsample/acs.jsp", setting.getSpAssertionConsumerServiceUrl().toString());
		assertEquals(setting.getSpAssertionConsumerServiceBinding(), "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST");
		assertEquals("http://localhost:5050/java-saml-jspsample/sls.jsp", setting.getSpSingleLogoutServiceUrl().toString());
	...
	public void testFromProperties() throws IOException, Error, CertificateException {
		...
		assertEquals("http://localhost:5050/java-saml-jspsample/metadata.jsp", setting2.getSpEntityId());
		assertEquals("http://localhost:5050/java-saml-jspsample/acs.jsp", setting2.getSpAssertionConsumerServiceUrl().toString());
		assertEquals(setting2.getSpAssertionConsumerServiceBinding(), "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST");
		assertEquals("http://localhost:5050/java-saml-jspsample/sls.jsp", setting2.getSpSingleLogoutServiceUrl().toString());
	...
	public void testLoadFromValues() throws Exception {
		...
		// Build SP
		samlData.put(SP_ENTITYID_PROPERTY_KEY, "http://localhost:5050/java-saml-jspsample/metadata.jsp");
		samlData.put(SP_ASSERTION_CONSUMER_SERVICE_URL_PROPERTY_KEY, "http://localhost:5050/java-saml-jspsample/acs.jsp");
		samlData.put(SP_ASSERTION_CONSUMER_SERVICE_BINDING_PROPERTY_KEY, "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST");
		samlData.put(SP_SINGLE_LOGOUT_SERVICE_URL_PROPERTY_KEY, "http://localhost:5050/java-saml-jspsample/sls.jsp");
	...
	public void testLoadFromValuesWithObjects() throws Exception {
		...
		// Build SP
		samlData.put(SP_ENTITYID_PROPERTY_KEY, "http://localhost:5050/java-saml-jspsample/metadata.jsp");
		samlData.put(SP_ASSERTION_CONSUMER_SERVICE_URL_PROPERTY_KEY, new URL("http://localhost:5050/java-saml-jspsample/acs.jsp"));
		samlData.put(SP_ASSERTION_CONSUMER_SERVICE_BINDING_PROPERTY_KEY, "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST");
		samlData.put(SP_SINGLE_LOGOUT_SERVICE_URL_PROPERTY_KEY, new URL("http://localhost:5050/java-saml-jspsample/sls.jsp"));
		samlData.put(SP_SINGLE_LOGOUT_SERVICE_BINDING_PROPERTY_KEY, "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect");
		samlData.put(SP_NAMEIDFORMAT_PROPERTY_KEY, "urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified");
		samlData.put(SP_X509CERT_PROPERTY_KEY, "-----BEGIN CERTIFICATE----------END CERTIFICATE-----");
		samlData.put(SP_PRIVATEKEY_PROPERTY_KEY, "-----BEGIN PRIVATE KEY----------END PRIVATE KEY-----");
